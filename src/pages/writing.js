...
const Writing = () => {
  ...
  return (
    <Layout pageName="Mosquito" title="Writing">
      ...
      <li>
        <a href="https://www.natbrut.com/heather-holmes">
          "Pisces,"
        </a>
        <i> Nat. Brut</i>
      </li>
      ...
      <li onClick={setView} className="link">
        ...
        <i> Songs for Sabotage</i>
        , 2018 New Museum
      </li>
      
      {viewPic && <StaticImage alt="Songs For Sabotage" src="../images/Songs+for+Sabotage__HH__WWIV.jpg"/>}
      ...
      <li>
        <a href="http://websafe2k16.com/CC00FF">
          "CC00FF,"&nbsp;
        </a>
        WebSafe2k16
      </li>
      ...
      <p>
        ...
        <i>&nbsp;the moon will sink into the street</i> for ICA Philadelphia in 2017 about the ongoingness of AIDS; that’s available
